...
const CompanyJobs: FC<Partial<Interface>> = () => {
  return (
    <div className="company-tabs-content w-tab-content">
      <div data-w-tab="Company Jobs" className="company-tab-pane w-tab-pane w--tab-active"
        ...
        className="title h3-size company-job-openings">Webflow job openings</h2>
          ...
          <div role="list" className="jobs-grid w-dyn-items">
            <div role="listitem" className="job-item w-dyn-item"><a href="/job/digital-marketing-specialist"
              ...
              <div className="split-content card-job-left">
                ...
                <div className="card-job-title-wrapper"><h3 className="title h6-size card-job">Digital
            ...
            <div role="listitem" className="job-item w-dyn-item"><a href="/job/backend-software-engineer"
              ...
              <div className="split-content card-job-left">
                ...
                <div className="card-job-title-wrapper"><h3 className="title h6-size card-job"
                                                            style={{color: "rgb(23, 23, 40)"}}>Backend Software
                  Engineer</h3>
                  <div className="card-link-wrapper">
                    <div className="card-link">Webflow</div>
                    <div className="card-link-arrow"
            ...
            <div role="listitem" className="job-item w-dyn-item"><a href="/job/executive-sales-manager"
              ...
              <div className="split-content card-job-left">
                <div className="image-wrapper card-job"><img
                  src="https://assets.website-files.com/60c77302fcfa2bdb6e595f76/60c7c888b67921277e81392e_icon-8-company-job-board-x-template.svg"
                  alt="Executive Sales Manager" className="image card-job"
                  style={{transform: "translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)", transformStyle: "preserve-3d"}}/>
                </div>
                <div className="card-job-title-wrapper"><h3 className="title h6-size card-job"
                                                            style={{color: "rgb(23, 23, 40)"}}>Executive Sales
                  Manager</h3>
                  <div className="card-link-wrapper">
                    <div className="card-link">Webflow</div>
                    <div className="card-link-arrow"
      ...
      <div data-w-tab="About Company" className="company-tab-pane w-tab-pane" id="w-tabs-0-data-w-pane-1"
        ...
        <div className="company-about-wrapper"><h2 className="title h3-size company-about">About the
          ...
          <div className="rich-text w-richtext"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
            ...
            Lectus duis amet tortor, sit tincidunt. Rhoncus tincidunt imperdiet penatibus vitae risus, vitae.
          </p><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lectus dictum ultrices lacus sodales
            nunc felis eu, consectetur arcu. Vitae nulla scelerisque id</p>
            <ul role="list">
          ...
          <div className="company-about-social-media-bottom-wrapper">
            ...
            <div className="company-about-social-media-wrapper"><a href="https://www.facebook.com/"
              ...
              className="image-wrapper social-media-link linkedin w-inline-block"></a><a
              href="https://www.youtube.com/" target="_blank"
              className="image-wrapper social-media-link youtube w-inline-block"></a></div>
          </div>
        </div>
      </div>
