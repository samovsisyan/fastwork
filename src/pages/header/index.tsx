      ...
      <div className="container-default w-container">
        <div className="header-wrapper">
          <div className="split-content header-right">
            ...
            alt="Job Board X Webflow Template - Logo" className="header-logo"/>
            </Link>
          </div>
          <div className="split-content header-center">
            <nav role="navigation" className="nav-menu w-nav-menu">
              <ul role="list" className="header-navigation">
                ...
                <li className="nav-item-wrapper"><Link to="/about" className="nav-link">About</Link></li>
                <li className="nav-item-wrapper"><Link to="/hero" className="nav-link">Hero</Link></li>
                <li className="nav-item-wrapper"><Link to="/blog" className="nav-link">Blog</Link></li>
                <li className="nav-item-wrapper"><Link to="/contact" className="nav-link">Contact</Link></li>
                <li className="nav-item-wrapper">
                    ...
                    <nav className="dropdown-list categories w-dropdown-list"
                      ...
                      <div className="dropdown-nav-main-wrapper">
                            ...
                            <div className="w-dyn-list">
                              <div role="list"
                                ...
                                <div role="listitem" className="jobs-filters-dropdown-link-item w-dyn-item"><a
                                  ...
                                  FL</a></div>
                                <div role="listitem" className="jobs-filters-dropdown-link-item w-dyn-item"><a
                                  href="/job-location-category/new-york-ny" className="dropdown-nav-link" >New
                                  York, NY</a></div>
                                <div role="listitem" className="jobs-filters-dropdown-link-item w-dyn-item"><a
                        ...
                        <div className="dropdown-nav-pages-wrapper last"><img
                          ...
                          <div className="dropdown-nav-content categories">
                            <div className="w-dyn-list">
                              <div role="list" className="jobs-filters-dropdown-links-grid header-dropdown w-dyn-items">
                                <div role="listitem" className="jobs-filters-dropdown-link-item w-dyn-item"><a
          ...
          <div className="split-content header-left"><a href="/post-a-job"
                                                        className="button-primary header-button w-button">Post a job</a>
