...
const JobPost: FC<Partial<Interface>> = () => {
  return (
      ...
      <div className="card job-post">
        <div data-w-id="ebcc2b89-9ed8-8b91-2d0e-6dfaa089b244" className="image-wrapper card-job-post">
          <img
            ...
            style={{
              ...
              transform: "translate3d(0px, -2.3809px, 0px) scale3d(1.0119, 1.0119, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
              transformStyle: 'preserve-3d',
            }}
          />
        </div>
        <div className="card-job-post-content">
          ...
          <div className="card-job-post-content-bottom">
            ...
            <a href="https://webflow.com/" target="_blank" className="button-primary apply-button w-button" >Apply now</a>
      </div>
    </div>
      </div>
    </div>
